...
export async function POST(request: Request) {
  try {
        ...
        <div style="background-color: #f9f9f9; padding: 20px; border-radius: 8px; margin: 20px 0;">
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 8px 0;"><strong>General Membership</strong></td>
            </tr>
            <tr>
              <td style="padding: 8px 0; font-weight: bold; color: #555;">Amount:</td>
              <td style="padding: 8px 0; font-size: 18px; color: #eb6e2d; font-weight: bold;">$100.00</td>
            </tr>
          </table>
        </div>
    ...
    await resend.emails.send({
      ...
      subject: "New Payment: General Membership",
