...
export default function SilverSponsorApplicationPage() {
  ...
  const sponsorTier = "Silver"
  const sponsorAmount = "$2,500"
  const stripeLink = "https://buy.stripe.com/aEU00n8ok1Ao3nxcMYbZe10"
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="inline-block px-4 py-2 bg-primary/10 border-2 border-primary rounded-full mb-4">
              <span className="text-primary font-bold text-sm uppercase tracking-wide">Most Popular</span>
            </div>
