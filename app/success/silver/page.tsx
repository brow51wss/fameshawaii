...
export default function SilverSponsorSuccessPage() {
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <h4 className="font-bold text-foreground mb-2">Online Recognition</h4>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="text-3xl mb-3">📧</div>
                <h4 className="font-bold text-foreground mb-2">Newsletter Features</h4>
                <p className="text-sm text-foreground/70">
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="text-3xl mb-3">🎫</div>
                <h4 className="font-bold text-foreground mb-2">Event Benefits</h4>
                <p className="text-sm text-foreground/70">
