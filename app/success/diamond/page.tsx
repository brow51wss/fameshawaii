...
export default function DiamondSponsorSuccessPage() {
  const { ref: heroRef, isVisible: heroVisible } = useScrollAnimation()
  const [emailSent, setEmailSent] = useState(false)
  const [isLoading, setIsLoading] = useState(true)

  const sponsorTier = "Diamond"
  const sponsorAmount = "$10,000"
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <h4 className="font-bold text-foreground mb-2">Speaking Opportunities</h4>
                <p className="text-sm text-foreground/70">
                  Premier access to speak at our signature events
                </p>
              </div>

              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="text-3xl mb-3">🌟</div>
                <h4 className="font-bold text-foreground mb-2">Premium Recognition</h4>
                <p className="text-sm text-foreground/70">
                  Featured logo placement on all marketing materials
                </p>
              </div>

              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="text-3xl mb-3">🤝</div>
                <h4 className="font-bold text-foreground mb-2">VIP Access</h4>
                <p className="text-sm text-foreground/70">
